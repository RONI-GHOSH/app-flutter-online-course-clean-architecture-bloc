...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4285750284),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4294959243),
      ...
      tertiaryFixedDim: Color(4293117037),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4287328803),
      ...
      tertiaryFixed: Color(4287328803),
      onTertiaryFixed: Color(4294967295),
      tertiaryFixedDim: Color(4285552905),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4293117037),
      onTertiary: Color(4282199808),
      tertiaryContainer: Color(4283974656),
      onTertiaryContainer: Color(4294959243),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(4293380208),
      onTertiary: Color(4280096000),
      tertiaryContainer: Color(4289302077),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(4293380208),
      onTertiaryContainer: Color(4278190080),
      ...
      tertiaryFixedDim: Color(4293380208),
